...
public class ApiUrl {
    ...
    /**
     * Get url, for getting weather forecast in city from api
     *
     * @param city - city for getting weather forecast
     * @return - api url with parameters, for getting
     * forecast weather.
     */
    public static String getUrlForWeatherForecastByCity(String city) {
        String parameters = "forecast/daily?q=" + city + "&cnt=" + forecastDatesCount
                + "&units=metric" + "&mode=xml" + "&appid=" + apiKey;
        return API_URL_WITHOUT_PARAMETERS + parameters;
    }
